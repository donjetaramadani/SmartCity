  ...
  export const Items = [
    {
      ...
      isOff: true,
      offPercentage: 10,
      productImage: require('../database/images/products/t1.png'),
      isAvailable: true,
      productImageList: [
    ...
    },
    {
      ...
      isOff: false,
      productImage: require('../database/images/products/t2.png'),
      isAvailable: true,
      productImageList: [
    ...
    },
    {
      ...
      isOff: true,
      offPercentage: 18,
      productImage: require('../database/images/products/t3.png'),
      isAvailable: true,
      productImageList: [
    ...
    },
    {
      ...
      isOff: false,
      productImage: require('../database/images/products/t4.png'),
      isAvailable: true,
      productImageList: [
    ...
    },
    {
      ...
      isOff: false,
      productImage: require('../database/images/products/t5.png'),
      isAvailable: false,
      productImageList: [
    ...
    },
    {
      ...
      isOff: false,
      productImage: require('../database/images/products/t6.png'),
      isAvailable: true,
      productImageList: [
